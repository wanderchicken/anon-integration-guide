export const ssrAbi = [
	...
	},
	{
		anonymous: false,
		inputs: [
			{ indexed: false, internalType: 'uint256', name: 'chi', type: 'uint256' },
	...
	{ inputs: [], name: 'chi', outputs: [{ internalType: 'uint192', name: '', type: 'uint192' }], stateMutability: 'view', type: 'function' },
	{
	...
	{ inputs: [{ internalType: 'address', name: 'usr', type: 'address' }], name: 'deny', outputs: [], stateMutability: 'nonpayable', type: 'function' },
	{
		inputs: [
	...
	{ inputs: [], name: 'drip', outputs: [{ internalType: 'uint256', name: 'nChi', type: 'uint256' }], stateMutability: 'nonpayable', type: 'function' },
	{
		inputs: [
	...
	{ inputs: [], name: 'getImplementation', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
	...
	{ inputs: [{ internalType: 'address', name: 'usr', type: 'address' }], name: 'rely', outputs: [], stateMutability: 'nonpayable', type: 'function' },
	{ inputs: [], name: 'rho', outputs: [{ internalType: 'uint64', name: '', type: 'uint64' }], stateMutability: 'view', type: 'function' },
	{ inputs: [], name: 'ssr', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
	...
	{ inputs: [], name: 'usds', outputs: [{ internalType: 'contract UsdsLike', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
	{ inputs: [], name: 'usdsJoin', outputs: [{ internalType: 'contract UsdsJoinLike', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
	{ inputs: [], name: 'vat', outputs: [{ internalType: 'contract VatLike', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
	{ inputs: [], name: 'version', outputs: [{ internalType: 'string', name: '', type: 'string' }], stateMutability: 'view', type: 'function' },
	{ inputs: [], name: 'vow', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
	{
		inputs: [{ internalType: 'address', name: '', type: 'address' }],
		name: 'wards',
		outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
